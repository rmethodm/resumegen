...
- **2026-09-08 — DESIGN.md Flat Design Corporativo tokens (app-wide).** Brand `#007BFF`, ink `#343A40`, page `#F8F9FA`, Lato + JetBrains Mono, radius 4/8/12px, chromatic success/warning/danger. Layout/copy unchanged — tokens only. **Why:** user replaced Conversion-Optimized `DESIGN.md` and asked to implement it.
