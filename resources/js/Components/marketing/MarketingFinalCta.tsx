...
export function MarketingFinalCta({ ctaHref }: { ctaHref: string }) {
    return (
        <section className="px-4 py-20 sm:px-6">
            <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[32px] bg-primary px-6 py-14 text-center sm:px-12 sm:py-16">
                <div
                ...
                <Link
                    href={ctaHref}
                    className={cn(
                        'relative mt-7 inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-[15px] font-bold text-primary',
                        'transition-[background-color,transform] duration-soft ease-soft hover:bg-accent active:scale-[0.98] motion-reduce:active:scale-100',
