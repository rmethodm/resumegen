...
/**
 * Legacy helper carried over from the pre-shadcn Button so existing callers
 * that style a non-`<button>` element (e.g. an Inertia `Link`) as a button
 * keep compiling. New code should prefer `<Button asChild>` + `Slot`.
 */
