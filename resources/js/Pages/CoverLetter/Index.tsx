                                        ...
                                        <tr key={l.id} className="border-b border-[#f5f5fb] transition-colors hover:bg-[#fafafe]">
                                            ...
                                            <td className="px-5 py-4">
                                                <div className="flex items-center justify-end gap-1">
                                                    <Link href={route('cover-letters.edit', l.id)} title="Edit" className="rounded-lg p-1.5 text-[#4338ca] hover:bg-[#eef2ff] transition"><PencilSquareIcon className="h-4 w-4" /></Link>
