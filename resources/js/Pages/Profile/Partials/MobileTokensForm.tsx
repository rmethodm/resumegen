...
export default function MobileTokensForm({
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900">iPhone app</h2>
            ...
            {plainToken ? (
                <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-4">
                    ...
                    <code className="mt-2 block break-all rounded bg-white px-3 py-2 text-xs text-gray-900 ring-1 ring-amber-100">
                        {plainToken}
                    </code>
            ...
            {tokens.length > 0 ? (
                ...
                <p className="mt-4 text-sm text-gray-500">No active iPhone app connections.</p>
            )}
        </section>
    );
}
